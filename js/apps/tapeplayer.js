 ...
 *   左 = 磁带架（VOL 分辑书脊行 + 搜索过滤 + 自动定位，点击放入，飞行入带动画）
...
(function () {
  ...
  var WIN98_TAPES = [
    ...
    { title: '岚', artist: '旧电脑', color: '#5b9cb8',
      src: 'assets/music/岚.mp3', cover: 'assets/music/岚.jpg', dur: 208.6,
      peaks: [0.25, 0.28, 0.28, 0.36, 0.36, 0.84, 0.84, 0.81, 0.56, 0.52, 0.42, 0.28, 0.44, 0.37, 0.3, 0.35, 0.57, 0.51, 0.42, 0.39, 0.52, 0.44, 0.54, 0.49, 0.65, 0.51, 0.68, 0.59, 0.68, 0.62, 0.65, 0.7, 0.87, 0.94, 0.92, 0.93, 0.84, 0.81, 0.87, 0.76, 0.74, 0.68, 0.56, 0.49, 0.82, 0.72, 0.74, 0.7, 0.82, 0.78, 0.57, 0.68, 0.57, 0.68, 0.65, 0.74, 0.67, 0.64, 0.73, 0.73, 0.88, 0.84, 0.8, 0.81, 0.78, 0.88, 0.92, 0.95, 0.86, 0.86, 0.82, 0.94, 0.93, 1.0, 0.98, 0.96, 0.91, 0.84, 0.84, 0.59, 0.51, 0.53, 0.52, 0.6, 0.72, 0.77, 0.75, 0.77, 0.74, 0.7, 0.81, 0.76, 0.67, 0.85, 0.87, 0.79, 0.97, 0.97, 0.95, 0.97, 0.89, 0.87, 0.82, 0.88, 0.86, 0.89, 0.87, 0.92, 0.79, 0.55, 0.42, 0.22] },
    { title: '忘川', artist: '旧电脑', color: '#6d8478',
      src: 'assets/music/忘川.mp3', cover: 'assets/music/忘川.jpg', dur: 242.4,
      peaks: [0.17, 0.28, 0.34, 0.38, 0.32, 0.37, 0.64, 0.58, 0.43, 0.31, 0.45, 0.46, 0.54, 0.56, 0.54, 0.64, 0.56, 0.5, 0.48, 0.57, 0.63, 0.6, 0.68, 0.69, 0.79, 0.69, 0.63, 0.54, 0.61, 0.8, 0.9, 0.94, 0.79, 0.88, 0.93, 0.89, 0.9, 0.79, 0.5, 0.5, 0.5, 0.48, 0.24, 0.7, 0.75, 0.57, 0.49, 0.51, 0.78, 0.77, 0.8, 0.83, 0.78, 0.91, 0.82, 0.63, 0.54, 0.78, 0.81, 0.79, 0.78, 0.74, 0.85, 0.75, 0.71, 0.73, 0.86, 0.93, 0.92, 0.93, 0.87, 0.91, 0.92, 0.9, 0.95, 0.73, 0.45, 0.52, 0.52, 0.55, 0.47, 0.42, 0.43, 0.47, 0.39, 0.45, 0.86, 0.75, 0.76, 0.71, 0.75, 0.86, 0.93, 0.94, 0.98, 0.8, 0.93, 0.99, 0.98, 1.0, 0.85, 0.51, 0.47, 0.5, 0.49, 0.21, 0.94, 0.64, 0.2, 0.39, 0.26, 0.17] },
    { title: '秋', artist: '旧电脑', color: '#6d6486',
      src: 'assets/music/秋.mp3', cover: 'assets/music/秋.jpg', dur: 181.5,
      peaks: [0.4, 0.45, 0.4, 0.42, 0.35, 0.34, 0.35, 0.41, 0.41, 0.53, 0.55, 0.64, 0.57, 0.67, 0.7, 0.69, 0.63, 0.67, 0.7, 0.65, 0.7, 0.73, 0.69, 0.75, 0.63, 0.3, 0.84, 0.92, 0.89, 0.88, 0.89, 0.86, 0.8, 0.82, 0.79, 0.85, 0.91, 0.82, 0.8, 0.89, 0.81, 0.95, 0.96, 0.95, 0.78, 0.82, 0.56, 0.56, 0.65, 0.85, 0.9, 0.79, 0.76, 0.89, 0.83, 0.84, 0.82, 0.84, 0.83, 0.85, 0.82, 0.78, 0.44, 0.72, 0.91, 0.9, 0.91, 0.85, 0.83, 0.82, 0.84, 0.81, 0.85, 0.84, 0.83, 0.84, 0.89, 0.83, 0.87, 0.89, 0.92, 0.77, 0.86, 0.86, 0.93, 0.93, 0.98, 0.98, 0.56, 0.44, 0.69, 0.69, 0.64, 0.66, 0.62, 0.61, 0.54, 0.84, 0.94, 1.0, 0.93, 0.88, 0.95, 0.9, 0.97, 0.9, 0.89, 0.89, 0.77, 0.95, 0.81, 0.37] },
    { title: '穷奇', artist: '旧电脑', color: '#a9823f',
      src: 'assets/music/穷奇.mp3', cover: 'assets/music/穷奇.jpg', dur: 235.1,
      peaks: [0.18, 0.37, 0.4, 0.5, 0.3, 0.48, 0.54, 0.45, 0.33, 0.58, 0.52, 0.65, 0.53, 0.59, 0.7, 0.62, 0.62, 0.63, 0.59, 0.65, 0.57, 0.6, 0.6, 0.71, 0.71, 0.87, 0.91, 0.89, 0.86, 0.83, 0.91, 0.92, 0.77, 0.47, 0.61, 0.7, 0.74, 0.71, 0.78, 0.7, 0.78, 0.72, 0.59, 0.59, 0.69, 0.74, 0.7, 0.72, 0.66, 0.69, 0.56, 0.61, 0.63, 0.68, 0.77, 0.7, 0.79, 0.8, 0.84, 0.88, 0.87, 0.8, 0.9, 0.87, 0.86, 0.82, 0.87, 0.89, 0.94, 0.83, 0.64, 0.68, 0.78, 0.73, 0.81, 0.78, 0.83, 0.77, 0.88, 0.87, 0.82, 0.86, 0.83, 0.87, 0.82, 0.68, 0.73, 0.79, 0.76, 0.79, 0.81, 0.77, 0.81, 0.68, 0.66, 0.88, 0.95, 0.9, 0.96, 0.91, 0.93, 0.93, 1.0, 0.9, 0.54, 0.72, 0.77, 0.52, 0.37, 0.53, 0.59, 0.38] },
    { title: '虚拟夜', artist: '旧电脑', color: '#5a4aef',
      src: 'assets/music/虚拟夜.mp3', cover: 'assets/music/虚拟夜.jpg', dur: 182.7,
      peaks: [0.4, 0.44, 0.73, 0.85, 0.86, 0.82, 0.9, 0.84, 0.83, 0.82, 0.81, 0.67, 0.71, 0.75, 0.77, 0.76, 0.78, 0.82, 0.77, 0.81, 0.67, 0.78, 0.86, 0.86, 0.83, 0.83, 0.71, 0.78, 0.83, 0.82, 0.72, 0.86, 0.83, 0.81, 0.85, 0.83, 0.82, 0.83, 0.84, 0.83, 0.81, 0.87, 0.86, 0.85, 0.8, 0.86, 0.89, 0.88, 0.88, 0.78, 0.56, 0.53, 0.52, 0.56, 0.81, 0.85, 0.79, 0.72, 0.72, 0.89, 0.88, 0.91, 0.88, 0.79, 0.79, 0.93, 0.85, 0.71, 0.87, 0.9, 0.85, 0.88, 0.93, 0.91, 0.92, 0.92, 0.92, 0.85, 0.65, 0.69, 0.57, 0.62, 0.72, 0.64, 0.56, 0.68, 0.74, 0.82, 0.86, 0.82, 0.8, 0.78, 0.72, 0.75, 0.71, 0.71, 0.81, 0.94, 0.91, 0.86, 0.96, 0.91, 0.93, 1.0, 0.9, 0.81, 0.89, 0.99, 0.76, 0.73, 0.81, 0.18] },
    { title: '江南夜', artist: '旧电脑', color: '#374a56',
      src: 'assets/music/江南夜.mp3', cover: 'assets/music/江南夜.jpg', dur: 192.9,
      peaks: [0.17, 0.41, 0.37, 0.4, 0.31, 0.58, 0.59, 0.63, 0.69, 0.69, 0.85, 0.92, 0.9, 0.86, 0.73, 0.73, 0.78, 0.71, 0.8, 0.71, 0.87, 0.79, 0.83, 0.85, 0.9, 0.81, 0.89, 0.86, 0.86, 0.8, 0.75, 0.63, 0.68, 0.89, 0.85, 0.87, 0.88, 0.85, 0.85, 0.88, 0.86, 0.89, 0.87, 0.86, 0.85, 0.92, 0.9, 0.76, 0.75, 0.78, 0.88, 0.81, 0.87, 0.87, 0.88, 0.84, 0.84, 0.81, 0.82, 0.8, 0.9, 0.82, 0.87, 0.87, 0.87, 0.89, 0.84, 0.86, 0.88, 0.84, 0.85, 0.65, 0.75, 0.77, 0.79, 0.78, 0.88, 0.91, 0.94, 0.94, 1, 0.92, 0.73, 0.72, 0.69, 0.7, 0.68, 0.86, 0.92, 0.88, 0.84, 0.87, 0.8, 0.89, 0.89, 0.85, 0.89, 0.83, 0.85, 0.88, 0.84, 0.78, 0.82, 0.85, 0.88, 0.87, 0.89, 0.88, 0.93, 0.87, 0.73, 0.19] }
  ];
  ...
  window.WIN98_APPS['tape'] = function (bodyEl, win, cfg) {
    ...
    bodyEl.innerHTML =
      '<div class="tp-zones">'
      + '<div class="tp-shelf"><div class="tp-shelf-h">TAPES · ' + WIN98_TAPES.length + '</div>'
      + '<input class="tp-search" type="text" placeholder="找磁带…" aria-label="搜索磁带">'
      + '<div class="tp-slots"></div></div>'
      + '<div class="tp-stage">'
    ...
    function tickUI() {
      ...
      $('.tp-lcd-track').textContent = 'TRK ' + ('0' + (S.deck + 1)).slice(-2);
    ...
    function insertTrack(i, autoplay) {
      ...
      fly(slotMiniRect(i), deckRect(), WIN98_TAPES[i], function () {
        ...
        tickUI();
        S.busy = false;
        applyFilter();      // 在带的那盘始终可见，不被搜索词藏掉
        scrollToSlot(i);    // 架子自动定位当前盘
    ...
    /* 磁带架：固定 5 盘一辑 VOL 分辑 + 搜索过滤（加歌只需往 WIN98_TAPES 末尾追加，自动落位） */
    var slotsBox = $('.tp-slots');
    var VOL_N = 5, volEls = [];
    WIN98_TAPES.forEach(function (t, i) {
      if (i % VOL_N === 0) {
        var v = document.createElement('div');
        v.className = 'tp-volcap';   // 勿用 tp-vol：机身音量滑杆组已占用
        v.textContent = 'VOL.' + (i / VOL_N + 1);
        slotsBox.appendChild(v);
        volEls.push(v);
      }
    ...
    emptyEl.className = 'tp-empty';
    emptyEl.textContent = '没找到这盘磁带';
    emptyEl.style.display = 'none';
    slotsBox.appendChild(emptyEl);

    /* 搜索过滤：命中标题/歌手（大小写不敏感）；在带的那盘始终可见——退带飞回要有锚点 */
    function applyFilter() {
      var q = $('.tp-search').value.trim().toLowerCase();
      var any = false;
      slotEls.forEach(function (el, i) {
        var t = WIN98_TAPES[i];
        var hit = !q || t.title.toLowerCase().indexOf(q) >= 0 || t.artist.toLowerCase().indexOf(q) >= 0;
        el.style.display = (hit || i === S.deck) ? '' : 'none';
        if (hit) any = true;
      });
      volEls.forEach(function (el) { el.style.display = q ? 'none' : ''; });
      emptyEl.style.display = any ? 'none' : '';
    }
    $('.tp-search').addEventListener('input', applyFilter);

    /* 自动定位：换带后架子滚到当前盘（已可见则不滚） */
    ...
    function onKey(e) {
      ...
      if (e.target && (e.target.tagName === 'INPUT' || e.target.tagName === 'TEXTAREA')) return;   // 搜索框打字不触发快捷键
