import{a as e,c as t,f as n,i as r,l as i,n as a,s as o}from"./index-DKlJkA9E.js";import{C as s,D as c,E as l,T as u,_ as d,a as f,b as p,c as m,g as h,h as g,i as _,m as v,n as y,o as b,p as x,s as S,t as C,u as w,w as T}from"./threeStage-BYIb9dXU.js";import{t as E}from"./_plugin-vue_export-helper-BDNMzG2s.js";var D={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},B=class extends O{constructor(){super(),this.isOutputPass=!0,this.uniforms=T.clone(z.uniforms),this.material=new d({name:z.name,uniforms:this.uniforms,vertexShader:z.vertexShader,fragmentShader:z.fragmentShader}),this._fsQuad=new j(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},S.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},V={class:`relative h-dvh w-full overflow-hidden bg-[#04050d] font-sans`},H={key:0,class:`pointer-events-none absolute inset-x-0 bottom-0 z-10 flex flex-col items-center gap-2 px-6 pb-9 text-center select-none`},U=E({__name:`galaxy`,props:{bare:Boolean},setup(s){let c=n(null),l=null,d=null,m={branches:4,radius:5,spin:1.15,randomness:.38,randomnessPower:3.2,insideColor:new b(`#ff9e5e`),outsideColor:new b(`#4a72d4`),coreColor:new b(`#ffe3b8`)};function g(e){let t=new Float32Array(e*3),n=new Float32Array(e*3),r=new Float32Array(e),i=Math.floor(e*.12);for(let a=0;a<e;a++){let e=a*3,o,s,c,l;if(a<i){l=Math.abs((Math.random()+Math.random()+Math.random()-1.5)/1.5)*m.radius*.22;let t=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1);o=l*Math.sin(i)*Math.cos(t),c=l*Math.sin(i)*Math.sin(t),s=l*Math.cos(i)*.55;let u=m.coreColor.clone().lerp(m.insideColor,l/(m.radius*.22));n[e]=u.r,n[e+1]=u.g,n[e+2]=u.b,r[a]=.6+Math.random()*.9}else{l=Math.random()**2*m.radius;let t=a%m.branches/m.branches*Math.PI*2+l*m.spin,i=Math.random()**+m.randomnessPower*(Math.random()<.5?1:-1)*m.randomness*l,u=Math.random()**+m.randomnessPower*(Math.random()<.5?1:-1)*m.randomness*l,d=Math.random()**+m.randomnessPower*(Math.random()<.5?1:-1)*m.randomness*l;o=Math.cos(t)*l+i,c=Math.sin(t)*l+d,s=u*.5;let f=m.insideColor.clone().lerp(m.outsideColor,(l/m.radius)**.8);n[e]=f.r,n[e+1]=f.g,n[e+2]=f.b,r[a]=.4+Math.random()*1.1}t[e]=o,t[e+1]=s,t[e+2]=c}let a=new f;return a.setAttribute(`position`,new _(t,3)),a.setAttribute(`aColor`,new _(n,3)),a.setAttribute(`aScale`,new _(r,1)),new h(a,new p({uniforms:{uSize:{value:22},uPixelRatio:{value:Math.min(window.devicePixelRatio,y()?1.5:2)}},transparent:!0,depthWrite:!1,blending:2,vertexShader:`
      uniform float uSize;
    ...
    `}))}return t(()=>{document.title=`展品 003 · 亿万星尘`;let e=y();l=C(c.value,{fov:45,cameraPos:[4.2,3,4.2],orbit:{minDistance:2.5,maxDistance:15,autoRotate:!0,autoRotateSpeed:.25},toneExposure:1});let{scene:t,camera:n,renderer:r}=l;t.background=new b(`#04050d`);let i=g(e?5e4:2e5);if(t.add(i),l.onTick(e=>{i.rotation.y+=e*.05}),!e){let e=r.getDrawingBufferSize(new u);d=new F(r),d.addPass(new I(t,n)),d.addPass(new R(new u(e.x/2,e.y/2),.38,.35,.2)),d.addPass(new B),l.setRender(()=>d.render()),l.onResizeFn((e,t)=>d.setSize(e,t))}}),o(()=>{d?.dispose?.(),l?.dispose()}),(t,n)=>(i(),e(`div`,V,[a(`div`,{ref_key:`stageEl`,ref:c,class:`absolute inset-0 touch-none`},null,512),s.bare?r(``,!0):(i(),e(`div`,H,[...n[0]||=[a(`p`,{class:`text-[11px] tracking-[0.55em] text-slate-500`},`EXHIBIT · 003`,-1),a(`h1`,{class:`text-4xl font-bold text-slate-100`},`亿万星尘`,-1),a(`p`,{class:`fade-in text-sm text-slate-300`,style:{"animation-delay":`0.8s`}},` 十万颗星尘在指尖旋转。你也是星尘，恰好会看星星的那种。 `,-1),a(`p`,{class:`fade-in text-xs text-slate-500`,style:{"animation-delay":`1.8s`}},` 拖动环顾，滚轮穿越星海。 `,-1)]])),n[1]||=a(`p`,{class:`absolute right-3 bottom-2 z-10 text-[10px] text-slate-600 select-none`},` three.js · 算法灵感 Three.js Journey「Galaxy Generator」 `,-1)]))}},[[`__scopeId`,`data-v-26e9ec11`]]);export{U as default};