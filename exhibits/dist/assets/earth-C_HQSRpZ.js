import{a as e,c as t,f as n,i as r,l as i,n as a,s as o}from"./index-DKlJkA9E.js";import{E as s,S as c,b as l,d as u,f as d,l as f,p,r as m,t as h,v as g,x as _}from"./threeStage-BYIb9dXU.js";import{t as v}from"./_plugin-vue_export-helper-BDNMzG2s.js";var y={class:`relative h-dvh w-full overflow-hidden bg-[#04060e] font-sans`},b={key:0,class:`absolute inset-0 z-10 flex items-center justify-center text-xs tracking-[0.4em] text-slate-500 select-none`},x={key:1,class:`pointer-events-none absolute inset-x-0 bottom-0 z-10 flex flex-col items-center gap-2 px-6 pb-9 text-center select-none`},S=v({__name:`earth`,props:{bare:Boolean},setup(v){let S=n(null),C=n(!1),w=null;return t(()=>{document.title=`展品 002 · 蓝色弹珠`,w=h(S.value,{fov:38,cameraPos:[0,.7,3.2],orbit:{minDistance:1.7,maxDistance:6,autoRotate:!0,autoRotateSpeed:.35},toneExposure:1.2});let{scene:e}=w,t=new c(new u(()=>{C.value=!0})),n=e=>{let n=t.load(m(e));return n.colorSpace=g,n.anisotropy=8,n},r=n(`earth-day.jpg`),i=n(`earth-night.jpg`),a=n(`2k_earth_clouds.jpg`),o=n(`night-sky.jpg`);o.mapping=303,e.background=o,e.backgroundIntensity=.5;let v=new s(2.5,1.4,4.2).normalize(),y=new f;y.rotation.z=d.degToRad(23.4),e.add(y);let b=new l({uniforms:{dayMap:{value:r},nightMap:{value:i},sunDirection:{value:v}},vertexShader:`
    ...
    `}),O=new p(new _(1.06,96,96),D);e.add(O),w.onTick(e=>{x.rotation.y+=e*(2*Math.PI/90),E.rotation.y+=e*(2*Math.PI/90)*1.35})}),o(()=>{w?.dispose()}),(t,n)=>(i(),e(`div`,y,[a(`div`,{ref_key:`stageEl`,ref:S,class:`absolute inset-0 touch-none`},null,512),C.value?r(``,!0):(i(),e(`div`,b,` 正在装载星光… `)),v.bare?r(``,!0):(i(),e(`div`,x,[...n[0]||=[a(`p`,{class:`text-[11px] tracking-[0.55em] text-slate-500`},`EXHIBIT · 002`,-1),a(`h1`,{class:`text-4xl font-bold text-slate-100`},`蓝色弹珠`,-1),a(`p`,{class:`fade-in text-sm text-slate-300`,style:{"animation-delay":`0.8s`}},` 1972 年，阿波罗 17 号回头看了一眼。此后我们都住在那张照片里。 `,-1),a(`p`,{class:`fade-in text-xs text-slate-500`,style:{"animation-delay":`1.8s`}},` 拖动，转动这颗星球；滚轮，靠近一点。 `,-1)]])),n[1]||=a(`p`,{class:`absolute right-3 bottom-2 z-10 text-[10px] text-slate-600 select-none`},` three.js · 贴图 NASA Blue Marble（公有领域）/ three-globe（MIT）/ Solar System Scope（CC BY 4.0） `,-1)]))}},[[`__scopeId`,`data-v-3aed7eb5`]]);export{S as default};